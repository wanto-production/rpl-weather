  ...
  return (
    <>
      <main className=' w-full h-screen flex justify-center items-center flex-col bg-[#BFA3D8]'>
        <header className=' w-full h-[60px] fixed top-0 flex justify-around items-center z-50 backdrop-blur-3xl'>
          <h1 className=' text-3xl font-semibold cursor-pointer text-white'><i className=' fa fa-cloud'></i></h1>
      ...
      <main className=' w-full h-[200px] bg-gray-700 flex flex-col p-3'>
        <h1 className=' text-white text-3xl font-mono'>ikhwan satrio</h1>
